...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticlesSlideshow'
        db.create_table('page_page_articlesslideshow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='articlesslideshow_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('page', ['ArticlesSlideshow'])


    def backwards(self, orm):
        # Deleting model 'ArticlesSlideshow'
        db.delete_table('page_page_articlesslideshow')

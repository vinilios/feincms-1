...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyContactFormContent.thanks_text'
        db.add_column('page_page_mycontactformcontent', 'thanks_text',
                      self.gf('django.db.models.fields.TextField')(default='\xce\x95\xcf\x85\xcf\x87\xce\xb1\xcf\x81\xce\xb9\xcf\x83\xcf\x84\xce\xbf\xcf\x8d\xce\xbc\xce\xb5!'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MyContactFormContent.thanks_text'
        db.delete_column('page_page_mycontactformcontent', 'thanks_text')
    ...
    models = {
        ...
        'page.articlesslideshow': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'ArticlesSlideshow', 'db_table': "'page_page_articlesslideshow'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articlesslideshow_set'", 'to': "orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'page.double': {
        ...
        'page.mycontactformcontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'MyContactFormContent', 'db_table': "'page_page_mycontactformcontent'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mycontactformcontent_set'", 'to': "orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'thanks_text': ('django.db.models.fields.TextField', [], {'default': "'\\xce\\x95\\xcf\\x85\\xcf\\x87\\xce\\xb1\\xcf\\x81\\xce\\xb9\\xcf\\x83\\xcf\\x84\\xce\\xbf\\xcf\\x8d\\xce\\xbc\\xce\\xb5!'"})
        },
        'page.page': {

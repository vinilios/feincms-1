...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('players_player', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Player.weight'
        db.alter_column('players_player', 'weight', self.gf('django.db.models.fields.IntegerField')())

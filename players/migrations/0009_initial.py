...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('players_general', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('bg_image', self.gf('feincms.module.medialibrary.fields.MediaFileForeignKey')(blank=True, related_name='background_image', null=True, to=orm['medialibrary.MediaFile'])),
            ('player_image', self.gf('feincms.module.medialibrary.fields.MediaFileForeignKey')(blank=True, related_name='default_player_image', null=True, to=orm['medialibrary.MediaFile'])),
        ))
        db.send_create_signal('players', ['General'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('players_general')
    ...
    models = {
        ...
        'players.general': {
            ...
            'bg_image': ('feincms.module.medialibrary.fields.MediaFileForeignKey', [], {'blank': 'True', 'related_name': "'background_image'", 'null': 'True', 'to': "orm['medialibrary.MediaFile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'player_image': ('feincms.module.medialibrary.fields.MediaFileForeignKey', [], {'blank': 'True', 'related_name': "'default_player_image'", 'null': 'True', 'to': "orm['medialibrary.MediaFile']"})
        },
        'players.player': {

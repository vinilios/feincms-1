...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.cv'
        db.alter_column('players_player', 'cv', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Player.cv'
        db.alter_column('players_player', 'cv', self.gf('django.db.models.fields.TextField')(default=''))
